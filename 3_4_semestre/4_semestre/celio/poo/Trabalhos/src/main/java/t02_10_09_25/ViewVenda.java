...
public class ViewVenda extends JPanel {
    ...
    private JTextField edtCodigo, edtProduto, edtQtd, edtPreco, edtDesc;
    ...
    public ViewVenda() {
        ...
        // ===== Título =====
        JLabel lblTitulo = new JLabel("Movimento de Venda", SwingConstants.CENTER);
        ...
        JLabel[] labels = {
            ...
            new JLabel("Preço:"), new JLabel("Desc.:")
        };
        JTextField[] edits = {
        ...
        // ===== Tabela =====
        modelo = new DefaultTableModel(new String[]{"Código", "Produto", "Qtd", "Preço", "Desc.", "Total"}, 0);
