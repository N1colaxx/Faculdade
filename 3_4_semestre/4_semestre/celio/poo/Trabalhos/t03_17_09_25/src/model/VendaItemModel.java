...
public class VendaItemModel {
    private int VEP_CODIGO;     // opcional para controle (PK)
    private int VDA_CODIGO;     // FK venda
    private int PRO_CODIGO;     // FK produto
    private String PRO_NOME;    // somente exibição
    private String PRO_UNIDADE; // somente exibição
    ...
    // Regra de cálculo do total (qtde * preço - desconto)
    public void recalc() {
        VEP_TOTAL = (VEP_QTDE * VEP_PRECO) - VEP_DESCONTO;
        if (VEP_TOTAL < 0) VEP_TOTAL = 0;
    }

    // Getters/Setters
    public int getVEP_CODIGO() { return VEP_CODIGO; }
    public void setVEP_CODIGO(int v) { VEP_CODIGO = v; }
    ...
    public double getVEP_QTDE() { return VEP_QTDE; }
    public void setVEP_QTDE(double v) { VEP_QTDE = v; }

    public double getVEP_PRECO() { return VEP_PRECO; }
    public void setVEP_PRECO(double v) { VEP_PRECO = v; }

    public double getVEP_DESCONTO() { return VEP_DESCONTO; }
    public void setVEP_DESCONTO(double v) { VEP_DESCONTO = v; }

    public double getVEP_TOTAL() { return VEP_TOTAL; }
    public void setVEP_TOTAL(double v) { VEP_TOTAL = v; }
}
