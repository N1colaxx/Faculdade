...
/**
 * Pagamento da venda (tabela venda_pagto).
 */
public class VendaPagtoModel {

    private int VDP_CODIGO;  // opcional
    private int VDA_CODIGO;  // FK venda
    private int FPG_CODIGO;  // FK forma pagto
    private String FPG_NOME; // exibição
    ...
    public void setVDP_CODIGO(int v) {
        VDP_CODIGO = v;
    }
    ...
    public void setVDP_VALOR(double v) {
        VDP_VALOR = v;
    }
}
