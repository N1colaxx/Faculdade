...
public class FormaPagamentoView extends JPanel {
    ...
    //  esse metodo é para: instanciar todos os componentes da tela (botões, labels, campos, tabela e containers).
    private void instanciar() {
        ...
        // Tabela
        tableModel = new FormaPagamentoTableModel(lista, colunas);
    ...
    //  esse metodo é para: adicionar os componentes aos painéis e montar a hierarquia visual.
    ...
    //  esse metodo é para: posicionar e dimensionar cada componente com coordenadas absolutas (layout fixo).
    ...
    //  esse metodo é para: configurar os listeners e regras dos botões (navegação, CRUD, consulta).
    ...
    //  esse metodo é para: ler a operação atual (incluir/alterar/””).
    private String getOperacao() { return operacao; }

    //  esse metodo é para: definir a operação atual e habilitar/desabilitar o botão Gravar.
    private void setOperacao(String operacao) {
        this.operacao = operacao;
        btnGravar.setEnabled(!operacao.isEmpty());
    }

    //  esse metodo é para: limpar todos os campos do formulário de cadastro.
    ...
    private FormaPagtoModel montarDosCampos() {
        ...
        f.setFPG_ATIVO(chkAtivo.isSelected() ? "S" : "N");
        return f;
    }

    //  esse metodo é para: construir a string de filtro (WHERE) usada na consulta.
