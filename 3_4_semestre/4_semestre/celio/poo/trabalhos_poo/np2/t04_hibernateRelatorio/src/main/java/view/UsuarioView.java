...
public class UsuarioView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Cadastro de Usuários com DAO/MVC/Hibernate/Relatório");
        getContentPane().add(lblTitulo);
        lblTitulo.setBounds(20, 80, 700, 17);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            ...
                            .addComponent(edtUSU_SENHA, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(27, 27, 27)
        ...
        jTabbedPane1.setBounds(10, 110, 710, 140);
        ...
        jTabbedPane2.setBounds(10, 260, 720, 330);
    ...
    private void btnGRAVARActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGRAVARActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirma Gravação deste Usuário ?",
            ...
            objModel.setUSU_CODIGO(Integer.parseInt(edtUSU_CODIGO.getText()));
            objModel.setUSU_NOME(edtUSU_NOME.getText());
            objModel.setUSU_LOGIN(edtUSU_LOGIN.getText());
            objModel.setUSU_SENHA(edtUSU_SENHA.getText());
//            objModel.setUSU_ATIVO((chkUSU_ATIVO.isSelected() ? 1 : 0));
    ...
    private void mostrar(UsuarioModel objModel) {
        edtUSU_CODIGO.setText(String.valueOf(objModel.getUSU_CODIGO()));
        edtUSU_NOME.setText(objModel.getUSU_NOME());
        edtUSU_LOGIN.setText(objModel.getUSU_LOGIN());
        edtUSU_SENHA.setText(objModel.getUSU_SENHA());
        chkUSU_ATIVO.setSelected((objModel.getUSU_ATIVO() == 1));
    }

    private String filtrar() {
        String condicao = "";
        if (!edtCONS_CODIGO1.getText().trim().equals("")) {
            condicao += "(USU_CODIGO >= " + edtCONS_CODIGO1.getText() + ")";
        }
