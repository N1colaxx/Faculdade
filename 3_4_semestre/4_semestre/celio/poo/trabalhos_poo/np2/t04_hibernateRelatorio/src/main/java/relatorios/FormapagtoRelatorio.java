...
public class FormapagtoRelatorio {

    private String nomeArquivo = "relatorioFormapagto.pdf";
    private String titulo = "Relatório de Forma de Pagamento";
    private PDDocument doc;
    private PDPage pagina;
    private PDPageContentStream cs;
    private int numeroPagina = 0;

    public void gerarRelatorio(List<FormapagtoModel> dados) {
        try {
            doc = new PDDocument();
            gerarPagina();
            gerarTabela(dados);
    ...
    private void gerarTabela(List<FormapagtoModel> dados) throws Exception {
        ...
        for (FormapagtoModel objModel : dados) {
