...
public class CompraProdutoRelatorio {
    ...
    public void gerarRelatorio(List<CompraProdutoModel> dados) {
        try {
            doc = new PDDocument();
            gerarPagina();
            gerarTabela(dados);
    ...
    private void gerarTabela(List<CompraProdutoModel> dados) throws Exception {
        ...
        for (CompraProdutoModel objModel : dados) {
